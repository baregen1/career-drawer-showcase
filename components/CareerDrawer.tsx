      ...
      {role && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className={`fixed inset-0 bg-black/80 z-[500] ${isLoFi ? "" : "backdrop-blur-md"}`}
          />
          ...
          <motion.div
            ...
            animate={{ y: 0 }}
            exit={{ y: "100%" }}
            transition={isLoFi ? { duration: 0 } : { type: "spring", damping: 30, stiffness: 300, mass: 0.8 }}
          ...
          >
            ...
            <div className={`sticky top-0 z-20 px-8 py-6 border-b rounded-t-[32px] ${
              isLoFi ? "transition-none" : "transition-all duration-500"
            } ${
              isScrolled 
                ? `bg-[#0a0a0a]/80 border-white/5 ${isLoFi ? "" : "backdrop-blur-md"}` 
                : "bg-transparent border-transparent"
            }`}>
              <div className="max-w-3xl mx-auto flex justify-between items-center">
                <div className={`flex flex-col ${isLoFi ? "transition-none" : "transition-opacity duration-300"} ${isScrolled ? "opacity-100" : "opacity-0"}`}>
